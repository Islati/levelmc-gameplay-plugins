...
import com.levelmc.core.api.particle.imagerenderer.event.ImageRenderingEvent;
...
/**
 * Uses the {@link ParticleRenderer} to render the given {@link BufferedImage}.
 */
public class ImageRenderer implements Renderer {
     ...
     * @param center The center location of the image. Represented as a {@link Location}.
    ...
    /**
     * @param image  The image that will be rendered. The pixel sum must not be bigger than 64^2 (e.g. 64*64 or 32*128).
     * @param center The center location of the image. Represented as a {@link Vec3d}.
     * @param far    Whether or not the image should be visible from far.
     * @param size   The size/movement direction of the individual particles.
     * @param speed  The speed of the particles.
     * @param amount The amount of Particles displayed per pixel.
