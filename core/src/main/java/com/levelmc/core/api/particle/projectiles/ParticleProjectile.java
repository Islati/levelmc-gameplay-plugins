package com.levelmc.core.api.particle.projectiles;

import com.levelmc.core.LevelCore;
import com.levelmc.core.api.events.particleprojectiles.*;
import org.bukkit.*;
...
/**
 * Base implementation of a particle projectile.
 * Credits to: https://github.com/coltonj96 for the library as discovered on spigotmc (https://www.spigotmc.org/resources/particleprojectileapi.48721/).
 */
public abstract class ParticleProjectile {
    ...
    public final void launch(final LivingEntity who, final World where, final Vector start, final Vector direction, final Vector start_offset, final Vector end_offset, final boolean physics) {
        ...
        }.runTaskTimer(LevelCore.getInstance(), 0, 1);
    }
     ...
     *
     * @param type Type of material to ignore
     */
     ...
     *
     * @param who   The source whom shot the projectile
     * @param world The world this occured in
     * @param start The start location of the projectile
     */
     ...
     * @param world The world this occured in
     * @param start The start location of the projectile
     * @param end   The end location of the projectile
     * @param t     Step
     */
     ...
     *
     * @param who   The entity whom launched the projectile
     * @param world The world this occured in
     * @param start The start location of the projectile
     * @param end   The end location of the projectile
     ...
     *
     * @param world    The world this occured in
     * @param previous The previous location of the projectile
     * @param current  The current location of the projectile
     * @param t        Step
     */
     ...
     * @param who   The entity whom launched the projectile
     * @param world The world this occured in
     * @param where The pass-through location of the projectile
