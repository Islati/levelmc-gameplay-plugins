...
public class ParticleRenderer implements Renderer {
    ...
    /**
     * Particle type. Refer to {@link Particles}
     */
    ...
    /**
     * @param particleParam Particle type. Refer to {@link Particles}
     * @param far           Determines whether or not the particle will be visible from far.
     * @param location      Location, where the particle will be rendered. Represented as a {@link Location}
     ...
     * @param particleParam Particle type. Refer to {@link Particles}
     * @param far           Determines whether or not the particle will be visible from far.
     * @param location      Location, where the particle will be rendered. Represented as a {@link Vec3d}.
     * @param size          Particle scale/movement direction.
     * @param speed         Speed of the particle.
     * @param amount        Amount of particles that will be rendered.
     */
    ...
    public void render(Player player) {
        ...
        ((CraftPlayer) player).getHandle().b.a(particles);
    }
